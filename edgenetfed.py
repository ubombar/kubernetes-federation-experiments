...
def edgenetfed_selectivedeployment_type_experiment(pod_count, namespace, federation_namespace, first_sleep_seconds, second_sleep_seconds, kubeconfig_file_worker1, kubeconfig_file_worker2, kubeconfig_file_fedmanager) -> dict:
